# # # # # # # # # # # # # # # # # # # # # 
# reads the outcome-of-care-measures.csv fille and returns a 2-column 
# data frame containing the hospital in each state that has the 
# ranking foopecified in num. For example the function call
# rankall("heart attack", "best") would return a data frame containing 
# the names of the hospitals that are the best in their respective 
# states for 30-day heart attack death rates. 
# # # # # # # # # # # # # # # # # # # # # 
